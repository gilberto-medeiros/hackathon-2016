...
class Player {
    constructor(deck, headHealth, bodyHealth, legHealth, stamina, playerId, matchId) {
        ...
        this.deck = deck;
        this.baseHeadHealth = headHealth;
        this.baseBodyHealth = bodyHealth;
        this.baseLegHealth =  legHealth;
        this.stamina = stamina;
        this.headLane = new HeadLane(this.baseHeadHealth);
        this.bodyLane = new BodyLane(this.baseBodyHealth);
        this.legsLane = new LegsLane(this.baseLegHealth);
